...
El objetivo del proyecto es el de transformar el problema del Sudoku a fórmulas lógicas para ser resueltos mediante un resolvedor de problemas lógicos SAT, para posteriormente transformar la solución obtenida a Sudoku, obteniendo la solución de éste.  
