...
/* Es posible adaptarlo para tener un solver para el N-Puzzle. Hay que tener en cuenta que se tendría que 
    cambiar la longitud de la secuencia a pedir al usuario y el tablero meta en el archivo Main.java; 
    y dependiendo del N, se tendria que considerar modificar o no las heuristicas
*/
import java.util.*;
public class Puzzle{
