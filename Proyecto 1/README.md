...
- La idea original era la de usar la propia heurística HH sobre el algoritmo IDA*, sin embargo, se vió que, si bien se obtenía soluciones de longitud óptima, el número de estados generados y el tiempo de respuesta no eran óptimos, tardando hasta varios minutos en computar una solución, y generando un número enorme de estados. 
